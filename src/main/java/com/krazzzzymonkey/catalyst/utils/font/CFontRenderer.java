...
public class CFontRenderer extends CFont
{
    ...
    public void drawLine(final double n, final double n2, final double n3, final double n4, final float n5) {
        GL11.glDisable(3553);
        GL11.glLineWidth(n5);
        GL11.glBegin(1);
        ...
        if (this.getStringWidth(s) > n) {
            ...
            if (str.length() > 0) {
                if (this.getStringWidth(str) < n) {
                    ...
                    final Iterator iterator = this.formatString(str, n).iterator();
    ...
    public int getStringWidth(final String s) {
        ...
        for (int length = s.length(), i = 0; i < length; ++i) {
            ...
            if (char1 == '§' && i < length) {
                ...
                n = n - (array[char1].width - 8 + this.charOffset) - 1;
            }
        }
        return n / 2;
    }
    ...
    public void setupMinecraftColorcodes() {
        for (int i = 0; i < 32; ++i) {
            ...
            final int[] colorCode = this.colorCode;
            final int n5 = i;
            final int n6 = (n2 & 0xFF) << 16 | (n3 & 0xFF) << 8;
            final int n7 = n4 & 0xFF;
            colorCode[n5] = n7 - (n6 & ~n7);
        }
    }
