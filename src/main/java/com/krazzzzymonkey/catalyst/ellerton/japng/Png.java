...
import com.krazzzzymonkey.catalyst.ellerton.japng.reader.DefaultPngChunkReader;
import com.krazzzzymonkey.catalyst.ellerton.japng.reader.PngChunkProcessor;
import com.krazzzzymonkey.catalyst.ellerton.japng.reader.PngReadHelper;
...
public class Png {
     ...
     */
    public static
    PngMap readMap(InputStream is, String sourceName) throws PngException {
        return PngReadHelper.read(is, new PngMapReader(sourceName));
    }

    public static
    PngContainer readContainer(InputStream is) throws PngException {
    ...
    public static
    Argb8888Bitmap readArgb8888Bitmap(InputStream is) throws PngException {
    ...
    public static
    Argb8888BitmapSequence readArgb8888BitmapSequence(InputStream is) throws PngException {
